...
from src.energy_forecast.config import DATA_DIR, RAW_DATA_DIR, META_DIR
    ...
    with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
        ...
        for xml_file in file_list:
            ...
            for building in root.findall(".//bldg:Building", namespaces):
                ...
                creation_date = building.find('core:creationDate', namespaces).text if building.find(
                    'core:creationDate',
                ...
                coords = [(coords_flat[i], coords_flat[i + 1], coords_flat[i + 2]) for i in
                          range(0, len(coords_flat), 3)]
