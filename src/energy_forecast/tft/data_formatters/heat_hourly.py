...
class HeatHourlyDataFormatter(GenericDataFormatter):
    ...
    _column_definition = [
        ...
        ('dwpt', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),  #
        ('rhum', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),  #
        ('coco', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),  #
