...
from src.energy_forecast.config import CONTINUOUS_FEATURES_CYCLIC, CATEGORICAL_FEATURES, FEATURE_SET_13, \
    CATEGORICAL_FEATURES_BINARY, DATA_DIR, FEATURE_SET_14
...
class HeatNoBuildingDataFormatter(GenericDataFormatter):
    ...
    def __init__(self):
        ...
        self.meta_features = FEATURE_SET_14
        self.cyclic_features = []
        self.encoded_columns = []
        self.cat_feature_names = []
        self.categorical_inputs = []
        self.features = FEATURE_SET_14  # can only be less features than meta features
